...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('documento_ingreso_head', function (Blueprint $table) {
            ...
            $table->unsignedInteger('tipo_operacion')->comment('llave foranea de la tabla tipo de operaciones');
            ...
            $table->unsignedInteger('comprobante_pago')->comment('llave foranea de la tabla comprobante_pago');
            $table->unsignedInteger('tipo_cambio')->comment('llave foranea de la tabla tipo cambio');
